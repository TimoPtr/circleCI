...
@Keep
class TestAnglesActivity : BaseDaggerActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_test_angles)
        extractIntentExtra()
    }

    override fun onBackPressed() {
        if (getCurrentNavFragment(R.id.nav_host_fragment) is TestAnglesConfirmationFragment) {
            finish()
...
@Keep
fun createTestAnglesIntent(
    context: Context,
    macAddress: String,
    toothbrushModel: ToothbrushModel
): Intent =
    Intent(context, TestAnglesActivity::class.java).apply {
