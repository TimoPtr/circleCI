...
@VisibleForApp
class ViewEnabledIdlingResource(
    @IdRes
    private val resId: Int,
    private val isEnabled: Boolean
) : OneTimeIdlingResource(
    name = "${ViewEnabledIdlingResource::class.simpleName}: $resId waiting for isEnabled = $isEnabled"
) {

    override fun isIdle(): Boolean {
        val view = IdlingResourceUtils.findView<View>(resId)
        return view != null && view.isEnabled == isEnabled
    }
}
