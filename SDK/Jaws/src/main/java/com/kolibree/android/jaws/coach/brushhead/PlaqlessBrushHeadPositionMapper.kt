...
/** [BrushHeadPositionMapper] implementation for Plaqless brush head 3D model */
internal class PlaqlessBrushHeadPositionMapper : BrushHeadPositionMapper {
    ...
    companion object {
        ...
        val POSITION_MATRIX_UpIncInt = arrayOf(
            floatArrayOf(-2.0f, 3.1f, 0.9f),
            floatArrayOf(10f, 90f, 0f), floatArrayOf(0f, 0f, 180f)
        )
        ...
        val POSITION_MATRIX_LoIncInt = arrayOf(
            floatArrayOf(1.5f, 3.1f, 0.75f),
            floatArrayOf(160f, 90f, 0f), floatArrayOf(0f, 0f, 180f)
        )
    }
}
