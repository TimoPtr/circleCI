...
/**
 * This class comes from https://gist.github.com/xanscale/e971cc4f2f0712a8a3bcc35e85325c27
 * It might needs some love
 * This customRenderer allows us to have bar with rounded corner
 */
@VisibleForApp
class RoundedBarChartRenderer(
    ...
    override fun drawDataSet(
        ...
        while (j < buffer.size()) {
            ...
            /* TODO This part doesn't work with the actual version
