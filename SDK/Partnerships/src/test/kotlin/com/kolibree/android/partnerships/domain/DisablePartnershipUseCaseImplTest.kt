...
internal class DisablePartnershipUseCaseImplTest : BaseUnitTest() {
    ...
    private val useCase = DisablePartnershipUseCaseImpl(
        repository = repository,
        accountInfoProvider = accountInfoProvider
    )

    @Test
    fun `disableCompletable subscribes to unlockPartnership after accountInfoProvider emits a value`() {
        ...
        val observer = useCase.disableCompletable(expectedPartner).test().assertNotComplete()
