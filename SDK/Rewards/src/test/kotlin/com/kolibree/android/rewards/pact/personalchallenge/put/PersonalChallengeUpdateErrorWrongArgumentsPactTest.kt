...
class PersonalChallengeUpdateErrorWrongArgumentsPactTest :
    ...
    override fun createPact(builder: PactDslWithProvider): RequestResponsePact {
        return builder
            ...
            .uponReceiving("update personal challenge fails for wrong arguments")
    ...
    private val requestBody =
        SharedTestUtils.getJson("personalchallenge/request_create_challenge_wrong_arguments.json")
}
