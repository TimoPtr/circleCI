...
internal class PrizesSynchronizationKeyBuilder
@Inject constructor(private val rewardsSynchronizedVersions: RewardsSynchronizedVersions) :
    SynchronizeAccountKeyBuilder(SynchronizableKey.PRIZES_CATALOG) {
    override fun version(): Int = rewardsSynchronizedVersions.prizesVersion()
}
