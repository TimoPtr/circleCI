...
internal class LifetimeSmilesSynchronizationKeyBuilder
@Inject constructor(private val rewardsSynchronizedVersions: RewardsSynchronizedVersions) :
    SynchronizeAccountKeyBuilder(SynchronizableKey.LIFETIME_SMILES) {
    override fun version(): Int = rewardsSynchronizedVersions.lifetimeSmilesVersion()
}
