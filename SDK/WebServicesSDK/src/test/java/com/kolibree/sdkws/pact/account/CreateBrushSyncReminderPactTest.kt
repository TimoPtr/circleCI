...
internal class CreateBrushSyncReminderPactTest : PactBaseTest<PactProviderState.TestProfileExists>(
    ...
    override fun runTest(mockServer: MockServer, context: PactTestExecutionContext) {
        ...
        val response = client.createBrushSyncReminder(
        ...
        TestCase.assertEquals(201, response.code())
    }
